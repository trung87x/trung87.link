...
const Page = () => {
  ...
  // Đường dẫn cơ sở đến thư mục chứa các file checkout-forms (Ecommerce Components)
  const baseDir =
    "src/app/(features)/tailwindcss/(ui)/(blocks)/ecommerce/components/checkout-forms";
